...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("terraform.plan.configuration", newTerraformPlanConfiguration)
...
func (s *mqlTerraform) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform].MqlCompute")
	switch name {
	case "files":
...
// Compute accessor autogenerated
func (s *mqlTerraformFile) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.file].MqlCompute")
	switch name {
	case "path":
		return nil
	case "blocks":
...
// Compute accessor autogenerated
func (s *mqlTerraformFileposition) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.fileposition].MqlCompute")
	switch name {
	case "path":
		return nil
	case "line":
...
// Compute accessor autogenerated
func (s *mqlTerraformBlock) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.block].MqlCompute")
	switch name {
	case "type":
		return nil
	case "nameLabel":
...
// Compute accessor autogenerated
func (s *mqlTerraformModule) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.module].MqlCompute")
	switch name {
	case "key":
		return nil
	case "source":
...
// Compute accessor autogenerated
func (s *mqlTerraformSettings) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.settings].MqlCompute")
	switch name {
	case "block":
		return nil
	case "requiredProviders":
...
// Compute accessor autogenerated
func (s *mqlTerraformState) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.state].MqlCompute")
	switch name {
	case "formatVersion":
		return nil
	case "terraformVersion":
...
// Compute accessor autogenerated
func (s *mqlTerraformStateOutput) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.state.output].MqlCompute")
	switch name {
	case "identifier":
		return nil
	case "sensitive":
...
// Compute accessor autogenerated
func (s *mqlTerraformStateModule) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.state.module].MqlCompute")
	switch name {
	case "address":
		return nil
	case "resources":
...
// Compute accessor autogenerated
func (s *mqlTerraformStateResource) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.state.resource].MqlCompute")
	switch name {
	case "address":
		return nil
	case "mode":
...
// Compute accessor autogenerated
func (s *mqlTerraformPlan) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.plan].MqlCompute")
	switch name {
	case "formatVersion":
		return nil
	case "terraformVersion":
...
type TerraformPlanConfiguration interface {
	...
	Register(string) error
	Validate() error
	ProviderConfig() ([]interface{}, error)
	Resources() ([]interface{}, error)
}
...
// MqlResource to retrieve the underlying resource info
func (s *mqlTerraformPlanConfiguration) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the terraform.plan.configuration resource
func newTerraformPlanConfiguration(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlTerraformPlanConfiguration{runtime.NewResource("terraform.plan.configuration")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "providerConfig":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"terraform.plan.configuration\", its \"providerConfig\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "resources":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"terraform.plan.configuration\", its \"resources\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"terraform.plan.configuration\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized terraform.plan.configuration with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlTerraformPlanConfiguration) Validate() error {
	// required arguments
	// no required fields found
...
// Register accessor autogenerated
func (s *mqlTerraformPlanConfiguration) Register(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.plan.configuration].Register")
	switch name {
	case "providerConfig":
		return nil
	case "resources":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"terraform.plan.configuration\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlTerraformPlanConfiguration) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[terraform.plan.configuration].Field")
	switch name {
	case "providerConfig":
	...
	case "resources":
		return s.Resources()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"terraform.plan.configuration\" resource")
	}
}

// ProviderConfig accessor autogenerated
func (s *mqlTerraformPlanConfiguration) ProviderConfig() ([]interface{}, error) {
	res, ok := s.Cache.Load("providerConfig")
	if !ok || !res.Valid {
		if err := s.ComputeProviderConfig(); err != nil {
			return nil, err
		}
		res, ok = s.Cache.Load("providerConfig")
		if !ok {
			return nil, errors.New("\"terraform.plan.configuration\" calculated \"providerConfig\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "providerConfig")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"terraform.plan.configuration\" failed to cast field \"providerConfig\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Resources accessor autogenerated
func (s *mqlTerraformPlanConfiguration) Resources() ([]interface{}, error) {
	res, ok := s.Cache.Load("resources")
	if !ok || !res.Valid {
		if err := s.ComputeResources(); err != nil {
			return nil, err
		...
		res, ok = s.Cache.Load("resources")
		if !ok {
			return nil, errors.New("\"terraform.plan.configuration\" calculated \"resources\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "resources")
	}
	if res.Error != nil {
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"terraform.plan.configuration\" failed to cast field \"resources\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlTerraformPlanConfiguration) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.plan.configuration].MqlCompute")
	switch name {
	case "providerConfig":
		return s.ComputeProviderConfig()
	case "resources":
		return s.ComputeResources()
	default:
		return errors.New("Cannot find field '" + name + "' in \"terraform.plan.configuration\" resource")
...
// ComputeProviderConfig computer autogenerated
func (s *mqlTerraformPlanConfiguration) ComputeProviderConfig() error {
	var err error
	if _, ok := s.Cache.Load("providerConfig"); ok {
		return nil
	}
	vres, err := s.GetProviderConfig()
	if _, ok := err.(resources.NotReadyError); ok {
		return err
	}
	s.Cache.Store("providerConfig", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
	return nil
}

// ComputeResources computer autogenerated
func (s *mqlTerraformPlanConfiguration) ComputeResources() error {
	var err error
	if _, ok := s.Cache.Load("resources"); ok {
		return nil
	}
...
// Compute accessor autogenerated
func (s *mqlTerraformPlanResourceChange) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.plan.resourceChange].MqlCompute")
	switch name {
	case "address":
		return nil
	case "previousAddress":
...
// Compute accessor autogenerated
func (s *mqlTerraformPlanProposedChange) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[terraform.plan.proposedChange].MqlCompute")
	switch name {
	case "address":
		return nil
	case "actions":
