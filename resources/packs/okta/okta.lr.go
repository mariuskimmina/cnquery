...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("okta.network", newOktaNetwork)
	registry.AddFactory("okta.threatsConfiguration", newOktaThreatsConfiguration)
}
...
func newOkta(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "networks":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"okta\", its \"networks\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlOkta) Networks() ([]interface{}, error) {
	...
	if !ok || !res.Valid {
		...
		res, ok = s.Cache.Load("networks")
		if !ok {
			return nil, errors.New("\"okta\" calculated \"networks\" but didn't find its value in cache.")
		}
	...
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"okta\" failed to cast field \"networks\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}
...
func (s *mqlOkta) ComputeNetworks() error {
	var err error
...
type OktaOrganization interface {
	...
	OptOutCommunicationEmails() (bool, error)
	BillingContact() (OktaUser, error)
	TechnicalContact() (OktaUser, error)
	SecurityNotificationEmails() (interface{}, error)
	ThreatInsightSettings() (OktaThreatsConfiguration, error)
}
...
func newOktaOrganization(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "optOutCommunicationEmails":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"okta.organization\", its \"optOutCommunicationEmails\" argument has the wrong type (expected type \"bool\")")
			}
		case "billingContact":
			if _, ok := val.(OktaUser); !ok {
				return nil, errors.New("Failed to initialize \"okta.organization\", its \"billingContact\" argument has the wrong type (expected type \"OktaUser\")")
			}
		case "technicalContact":
			if _, ok := val.(OktaUser); !ok {
				return nil, errors.New("Failed to initialize \"okta.organization\", its \"technicalContact\" argument has the wrong type (expected type \"OktaUser\")")
			}
		case "securityNotificationEmails":
			if _, ok := val.(interface{}); !ok {
				return nil, errors.New("Failed to initialize \"okta.organization\", its \"securityNotificationEmails\" argument has the wrong type (expected type \"interface{}\")")
			}
		case "threatInsightSettings":
			if _, ok := val.(OktaThreatsConfiguration); !ok {
				return nil, errors.New("Failed to initialize \"okta.organization\", its \"threatInsightSettings\" argument has the wrong type (expected type \"OktaThreatsConfiguration\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlOktaOrganization) Field(name string) (interface{}, error) {
	...
	case "expiresAt":
		return s.ExpiresAt()
	case "optOutCommunicationEmails":
		return s.OptOutCommunicationEmails()
	case "billingContact":
		return s.BillingContact()
	case "technicalContact":
		return s.TechnicalContact()
	case "securityNotificationEmails":
		return s.SecurityNotificationEmails()
	case "threatInsightSettings":
		return s.ThreatInsightSettings()
	default:
...
// OptOutCommunicationEmails accessor autogenerated
func (s *mqlOktaOrganization) OptOutCommunicationEmails() (bool, error) {
	res, ok := s.Cache.Load("optOutCommunicationEmails")
	if !ok || !res.Valid {
		if err := s.ComputeOptOutCommunicationEmails(); err != nil {
			return false, err
		}
		res, ok = s.Cache.Load("optOutCommunicationEmails")
		if !ok {
			return false, errors.New("\"okta.organization\" calculated \"optOutCommunicationEmails\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "optOutCommunicationEmails")
	}
	if res.Error != nil {
	...
	if !ok {
		return false, fmt.Errorf("\"okta.organization\" failed to cast field \"optOutCommunicationEmails\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// BillingContact accessor autogenerated
func (s *mqlOktaOrganization) BillingContact() (OktaUser, error) {
	res, ok := s.Cache.Load("billingContact")
	if !ok || !res.Valid {
		if err := s.ComputeBillingContact(); err != nil {
			return nil, err
		}
		res, ok = s.Cache.Load("billingContact")
		if !ok {
			return nil, errors.New("\"okta.organization\" calculated \"billingContact\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "billingContact")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(OktaUser)
	if !ok {
		return nil, fmt.Errorf("\"okta.organization\" failed to cast field \"billingContact\" to the right type (OktaUser): %#v", res)
	}
	return tres, nil
}

// TechnicalContact accessor autogenerated
func (s *mqlOktaOrganization) TechnicalContact() (OktaUser, error) {
	res, ok := s.Cache.Load("technicalContact")
	if !ok || !res.Valid {
		if err := s.ComputeTechnicalContact(); err != nil {
			return nil, err
		}
		res, ok = s.Cache.Load("technicalContact")
		if !ok {
			return nil, errors.New("\"okta.organization\" calculated \"technicalContact\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "technicalContact")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(OktaUser)
	if !ok {
		return nil, fmt.Errorf("\"okta.organization\" failed to cast field \"technicalContact\" to the right type (OktaUser): %#v", res)
	}
	return tres, nil
}

// SecurityNotificationEmails accessor autogenerated
func (s *mqlOktaOrganization) SecurityNotificationEmails() (interface{}, error) {
	res, ok := s.Cache.Load("securityNotificationEmails")
	if !ok || !res.Valid {
		if err := s.ComputeSecurityNotificationEmails(); err != nil {
			return nil, err
		}
		res, ok = s.Cache.Load("securityNotificationEmails")
		if !ok {
			return nil, errors.New("\"okta.organization\" calculated \"securityNotificationEmails\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "securityNotificationEmails")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(interface{})
	if !ok {
		return nil, fmt.Errorf("\"okta.organization\" failed to cast field \"securityNotificationEmails\" to the right type (interface{}): %#v", res)
	}
	return tres, nil
}

// ThreatInsightSettings accessor autogenerated
func (s *mqlOktaOrganization) ThreatInsightSettings() (OktaThreatsConfiguration, error) {
	res, ok := s.Cache.Load("threatInsightSettings")
	if !ok || !res.Valid {
		if err := s.ComputeThreatInsightSettings(); err != nil {
			return nil, err
		}
		res, ok = s.Cache.Load("threatInsightSettings")
		if !ok {
			return nil, errors.New("\"okta.organization\" calculated \"threatInsightSettings\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "threatInsightSettings")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(OktaThreatsConfiguration)
	if !ok {
		return nil, fmt.Errorf("\"okta.organization\" failed to cast field \"threatInsightSettings\" to the right type (OktaThreatsConfiguration): %#v", res)
	}
	return tres, nil
}
...
func (s *mqlOktaOrganization) MqlCompute(name string) error {
	...
	case "expiresAt":
		return nil
	case "optOutCommunicationEmails":
		return s.ComputeOptOutCommunicationEmails()
	case "billingContact":
		return s.ComputeBillingContact()
	case "technicalContact":
		return s.ComputeTechnicalContact()
	case "securityNotificationEmails":
		return s.ComputeSecurityNotificationEmails()
	case "threatInsightSettings":
		return s.ComputeThreatInsightSettings()
	default:
		return errors.New("Cannot find field '" + name + "' in \"okta.organization\" resource")
	}
}

// ComputeOptOutCommunicationEmails computer autogenerated
func (s *mqlOktaOrganization) ComputeOptOutCommunicationEmails() error {
	var err error
	if _, ok := s.Cache.Load("optOutCommunicationEmails"); ok {
		return nil
	}
	vres, err := s.GetOptOutCommunicationEmails()
	if _, ok := err.(resources.NotReadyError); ok {
		return err
	}
	s.Cache.Store("optOutCommunicationEmails", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
	return nil
}

// ComputeBillingContact computer autogenerated
func (s *mqlOktaOrganization) ComputeBillingContact() error {
	var err error
	if _, ok := s.Cache.Load("billingContact"); ok {
		return nil
	}
	vres, err := s.GetBillingContact()
	if _, ok := err.(resources.NotReadyError); ok {
		return err
	}
	s.Cache.Store("billingContact", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
	return nil
}

// ComputeTechnicalContact computer autogenerated
func (s *mqlOktaOrganization) ComputeTechnicalContact() error {
	var err error
	if _, ok := s.Cache.Load("technicalContact"); ok {
		return nil
	}
	vres, err := s.GetTechnicalContact()
	if _, ok := err.(resources.NotReadyError); ok {
		return err
	}
	s.Cache.Store("technicalContact", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
	return nil
}

// ComputeSecurityNotificationEmails computer autogenerated
func (s *mqlOktaOrganization) ComputeSecurityNotificationEmails() error {
	var err error
	if _, ok := s.Cache.Load("securityNotificationEmails"); ok {
		return nil
	}
	vres, err := s.GetSecurityNotificationEmails()
	if _, ok := err.(resources.NotReadyError); ok {
		return err
	}
	s.Cache.Store("securityNotificationEmails", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
	return nil
}

// ComputeThreatInsightSettings computer autogenerated
func (s *mqlOktaOrganization) ComputeThreatInsightSettings() error {
	var err error
	if _, ok := s.Cache.Load("threatInsightSettings"); ok {
		return nil
	}
	vres, err := s.GetThreatInsightSettings()
	if _, ok := err.(resources.NotReadyError); ok {
		return err
	}
	s.Cache.Store("threatInsightSettings", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
	return nil
}
...
type OktaNetwork interface {
	...
	Status() (string, error)
	System() (bool, error)
	Asns() ([]interface{}, error)
	Usage() (string, error)
	ProxyType() (string, error)
	Proxies() ([]interface{}, error)
	Locations() ([]interface{}, error)
	Gateways() ([]interface{}, error)
}
...
// MqlResource to retrieve the underlying resource info
func (s *mqlOktaNetwork) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the okta.network resource
func newOktaNetwork(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlOktaNetwork{runtime.NewResource("okta.network")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "type":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"type\" argument has the wrong type (expected type \"string\")")
			}
		case "created":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"created\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "lastUpdated":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"lastUpdated\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "status":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"status\" argument has the wrong type (expected type \"string\")")
			}
		case "system":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"system\" argument has the wrong type (expected type \"bool\")")
			}
		case "asns":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"asns\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "usage":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"usage\" argument has the wrong type (expected type \"string\")")
			}
		case "proxyType":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"proxyType\" argument has the wrong type (expected type \"string\")")
			}
		case "proxies":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"proxies\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "locations":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"locations\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "gateways":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"gateways\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"okta.network\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized okta.network with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlOktaNetwork) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("type"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"type\". This field is required.")
	}
	if _, ok := s.Cache.Load("created"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"created\". This field is required.")
	}
	if _, ok := s.Cache.Load("lastUpdated"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"lastUpdated\". This field is required.")
	}
	if _, ok := s.Cache.Load("status"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"status\". This field is required.")
	}
	if _, ok := s.Cache.Load("system"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"system\". This field is required.")
	}
	if _, ok := s.Cache.Load("asns"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"asns\". This field is required.")
	}
	if _, ok := s.Cache.Load("usage"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"usage\". This field is required.")
	}
	if _, ok := s.Cache.Load("proxyType"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"proxyType\". This field is required.")
	}
	if _, ok := s.Cache.Load("proxies"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"proxies\". This field is required.")
	}
	if _, ok := s.Cache.Load("locations"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"locations\". This field is required.")
	}
	if _, ok := s.Cache.Load("gateways"); !ok {
		return errors.New("Initialized \"okta.network\" resource without a \"gateways\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlOktaNetwork) Register(name string) error {
	log.Trace().Str("field", name).Msg("[okta.network].Register")
	switch name {
	case "id":
		return nil
	case "name":
	...
	case "gateways":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"okta.network\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlOktaNetwork) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[okta.network].Field")
	switch name {
	case "id":
		return s.Id()
	case "name":
	...
	case "gateways":
		return s.Gateways()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"okta.network\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlOktaNetwork) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"okta.network\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"okta.network\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlOktaNetwork) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"okta.network\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"okta.network\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Type accessor autogenerated
func (s *mqlOktaNetwork) Type() (string, error) {
	res, ok := s.Cache.Load("type")
	if !ok || !res.Valid {
		return "", errors.New("\"okta.network\" failed: no value provided for static field \"type\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"okta.network\" failed to cast field \"type\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Created accessor autogenerated
func (s *mqlOktaNetwork) Created() (*time.Time, error) {
	res, ok := s.Cache.Load("created")
	if !ok || !res.Valid {
		return nil, errors.New("\"okta.network\" failed: no value provided for static field \"created\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"okta.network\" failed to cast field \"created\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// LastUpdated accessor autogenerated
func (s *mqlOktaNetwork) LastUpdated() (*time.Time, error) {
	res, ok := s.Cache.Load("lastUpdated")
	if !ok || !res.Valid {
		return nil, errors.New("\"okta.network\" failed: no value provided for static field \"lastUpdated\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"okta.network\" failed to cast field \"lastUpdated\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Status accessor autogenerated
func (s *mqlOktaNetwork) Status() (string, error) {
	res, ok := s.Cache.Load("status")
	if !ok || !res.Valid {
		return "", errors.New("\"okta.network\" failed: no value provided for static field \"status\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"okta.network\" failed to cast field \"status\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// System accessor autogenerated
func (s *mqlOktaNetwork) System() (bool, error) {
	res, ok := s.Cache.Load("system")
	if !ok || !res.Valid {
		return false, errors.New("\"okta.network\" failed: no value provided for static field \"system\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"okta.network\" failed to cast field \"system\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// Asns accessor autogenerated
func (s *mqlOktaNetwork) Asns() ([]interface{}, error) {
	res, ok := s.Cache.Load("asns")
	if !ok || !res.Valid {
		return nil, errors.New("\"okta.network\" failed: no value provided for static field \"asns\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"okta.network\" failed to cast field \"asns\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Usage accessor autogenerated
func (s *mqlOktaNetwork) Usage() (string, error) {
	res, ok := s.Cache.Load("usage")
	if !ok || !res.Valid {
		return "", errors.New("\"okta.network\" failed: no value provided for static field \"usage\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"okta.network\" failed to cast field \"usage\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ProxyType accessor autogenerated
func (s *mqlOktaNetwork) ProxyType() (string, error) {
	res, ok := s.Cache.Load("proxyType")
	if !ok || !res.Valid {
		return "", errors.New("\"okta.network\" failed: no value provided for static field \"proxyType\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"okta.network\" failed to cast field \"proxyType\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Proxies accessor autogenerated
func (s *mqlOktaNetwork) Proxies() ([]interface{}, error) {
	res, ok := s.Cache.Load("proxies")
	if !ok || !res.Valid {
		return nil, errors.New("\"okta.network\" failed: no value provided for static field \"proxies\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"okta.network\" failed to cast field \"proxies\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Locations accessor autogenerated
func (s *mqlOktaNetwork) Locations() ([]interface{}, error) {
	res, ok := s.Cache.Load("locations")
	if !ok || !res.Valid {
		return nil, errors.New("\"okta.network\" failed: no value provided for static field \"locations\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"okta.network\" failed to cast field \"locations\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Gateways accessor autogenerated
func (s *mqlOktaNetwork) Gateways() ([]interface{}, error) {
	res, ok := s.Cache.Load("gateways")
	if !ok || !res.Valid {
		return nil, errors.New("\"okta.network\" failed: no value provided for static field \"gateways\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"okta.network\" failed to cast field \"gateways\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlOktaNetwork) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[okta.network].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// MqlResource to retrieve the underlying resource info
func (s *mqlOktaThreatsConfiguration) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the okta.threatsConfiguration resource
func newOktaThreatsConfiguration(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlOktaThreatsConfiguration{runtime.NewResource("okta.threatsConfiguration")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "action":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"okta.threatsConfiguration\", its \"action\" argument has the wrong type (expected type \"string\")")
			}
		case "excludeZones":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"okta.threatsConfiguration\", its \"excludeZones\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "created":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"okta.threatsConfiguration\", its \"created\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "lastUpdated":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"okta.threatsConfiguration\", its \"lastUpdated\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"okta.threatsConfiguration\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized okta.threatsConfiguration with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlOktaThreatsConfiguration) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("action"); !ok {
		return errors.New("Initialized \"okta.threatsConfiguration\" resource without a \"action\". This field is required.")
	}
	if _, ok := s.Cache.Load("excludeZones"); !ok {
		return errors.New("Initialized \"okta.threatsConfiguration\" resource without a \"excludeZones\". This field is required.")
	}
	if _, ok := s.Cache.Load("created"); !ok {
		return errors.New("Initialized \"okta.threatsConfiguration\" resource without a \"created\". This field is required.")
	}
	if _, ok := s.Cache.Load("lastUpdated"); !ok {
		return errors.New("Initialized \"okta.threatsConfiguration\" resource without a \"lastUpdated\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlOktaThreatsConfiguration) Register(name string) error {
	log.Trace().Str("field", name).Msg("[okta.threatsConfiguration].Register")
	switch name {
	case "action":
		return nil
	case "excludeZones":
...
// Field accessor autogenerated
func (s *mqlOktaThreatsConfiguration) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[okta.threatsConfiguration].Field")
	switch name {
	case "action":
		return s.Action()
	case "excludeZones":
		return s.ExcludeZones()
	case "created":
		return s.Created()
	case "lastUpdated":
		return s.LastUpdated()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"okta.threatsConfiguration\" resource")
	}
}

// Action accessor autogenerated
func (s *mqlOktaThreatsConfiguration) Action() (string, error) {
	res, ok := s.Cache.Load("action")
	if !ok || !res.Valid {
		return "", errors.New("\"okta.threatsConfiguration\" failed: no value provided for static field \"action\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"okta.threatsConfiguration\" failed to cast field \"action\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// ExcludeZones accessor autogenerated
func (s *mqlOktaThreatsConfiguration) ExcludeZones() ([]interface{}, error) {
	res, ok := s.Cache.Load("excludeZones")
	if !ok || !res.Valid {
		return nil, errors.New("\"okta.threatsConfiguration\" failed: no value provided for static field \"excludeZones\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"okta.threatsConfiguration\" failed to cast field \"excludeZones\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Created accessor autogenerated
func (s *mqlOktaThreatsConfiguration) Created() (*time.Time, error) {
	res, ok := s.Cache.Load("created")
	if !ok || !res.Valid {
		return nil, errors.New("\"okta.threatsConfiguration\" failed: no value provided for static field \"created\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"okta.threatsConfiguration\" failed to cast field \"created\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// LastUpdated accessor autogenerated
func (s *mqlOktaThreatsConfiguration) LastUpdated() (*time.Time, error) {
	res, ok := s.Cache.Load("lastUpdated")
	if !ok || !res.Valid {
		return nil, errors.New("\"okta.threatsConfiguration\" failed: no value provided for static field \"lastUpdated\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"okta.threatsConfiguration\" failed to cast field \"lastUpdated\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlOktaThreatsConfiguration) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[okta.threatsConfiguration].MqlCompute")
	switch name {
	case "action":
		return nil
	case "excludeZones":
