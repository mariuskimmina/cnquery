...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("googleworkspace.connectedApp", newGoogleworkspaceConnectedApp)
...
func newGoogleworkspace(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "connectedApps":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"googleworkspace\", its \"connectedApps\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
// ConnectedApps accessor autogenerated
func (s *mqlGoogleworkspace) ConnectedApps() ([]interface{}, error) {
	res, ok := s.Cache.Load("connectedApps")
	if !ok || !res.Valid {
		if err := s.ComputeConnectedApps(); err != nil {
			return nil, err
		}
		res, ok = s.Cache.Load("connectedApps")
		if !ok {
			return nil, errors.New("\"googleworkspace\" calculated \"connectedApps\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "connectedApps")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"googleworkspace\" failed to cast field \"connectedApps\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}
...
// ComputeConnectedApps computer autogenerated
func (s *mqlGoogleworkspace) ComputeConnectedApps() error {
	var err error
	if _, ok := s.Cache.Load("connectedApps"); ok {
		return nil
	}
	vres, err := s.GetConnectedApps()
	if _, ok := err.(resources.NotReadyError); ok {
		return err
	}
	s.Cache.Store("connectedApps", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
	return nil
}
...
// MqlResource to retrieve the underlying resource info
func (s *mqlGoogleworkspaceConnectedApp) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the googleworkspace.connectedApp resource
func newGoogleworkspaceConnectedApp(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGoogleworkspaceConnectedApp{runtime.NewResource("googleworkspace.connectedApp")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "clientId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"googleworkspace.connectedApp\", its \"clientId\" argument has the wrong type (expected type \"string\")")
			}
		case "name":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"googleworkspace.connectedApp\", its \"name\" argument has the wrong type (expected type \"string\")")
			}
		case "scopes":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"googleworkspace.connectedApp\", its \"scopes\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "users":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"googleworkspace.connectedApp\", its \"users\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "tokens":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"googleworkspace.connectedApp\", its \"tokens\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"googleworkspace.connectedApp\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized googleworkspace.connectedApp with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGoogleworkspaceConnectedApp) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("clientId"); !ok {
		return errors.New("Initialized \"googleworkspace.connectedApp\" resource without a \"clientId\". This field is required.")
	}
	if _, ok := s.Cache.Load("name"); !ok {
		return errors.New("Initialized \"googleworkspace.connectedApp\" resource without a \"name\". This field is required.")
	}
	if _, ok := s.Cache.Load("scopes"); !ok {
		return errors.New("Initialized \"googleworkspace.connectedApp\" resource without a \"scopes\". This field is required.")
	}
	if _, ok := s.Cache.Load("users"); !ok {
		return errors.New("Initialized \"googleworkspace.connectedApp\" resource without a \"users\". This field is required.")
	}
	if _, ok := s.Cache.Load("tokens"); !ok {
		return errors.New("Initialized \"googleworkspace.connectedApp\" resource without a \"tokens\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGoogleworkspaceConnectedApp) Register(name string) error {
	log.Trace().Str("field", name).Msg("[googleworkspace.connectedApp].Register")
	switch name {
	case "clientId":
		return nil
	case "name":
	...
	case "tokens":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"googleworkspace.connectedApp\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGoogleworkspaceConnectedApp) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[googleworkspace.connectedApp].Field")
	switch name {
	case "clientId":
		return s.ClientId()
	case "name":
	...
	case "tokens":
		return s.Tokens()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"googleworkspace.connectedApp\" resource")
	}
}

// ClientId accessor autogenerated
func (s *mqlGoogleworkspaceConnectedApp) ClientId() (string, error) {
	res, ok := s.Cache.Load("clientId")
	if !ok || !res.Valid {
		return "", errors.New("\"googleworkspace.connectedApp\" failed: no value provided for static field \"clientId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"googleworkspace.connectedApp\" failed to cast field \"clientId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Name accessor autogenerated
func (s *mqlGoogleworkspaceConnectedApp) Name() (string, error) {
	res, ok := s.Cache.Load("name")
	if !ok || !res.Valid {
		return "", errors.New("\"googleworkspace.connectedApp\" failed: no value provided for static field \"name\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"googleworkspace.connectedApp\" failed to cast field \"name\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Scopes accessor autogenerated
func (s *mqlGoogleworkspaceConnectedApp) Scopes() ([]interface{}, error) {
	res, ok := s.Cache.Load("scopes")
	if !ok || !res.Valid {
		return nil, errors.New("\"googleworkspace.connectedApp\" failed: no value provided for static field \"scopes\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"googleworkspace.connectedApp\" failed to cast field \"scopes\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Users accessor autogenerated
func (s *mqlGoogleworkspaceConnectedApp) Users() ([]interface{}, error) {
	res, ok := s.Cache.Load("users")
	if !ok || !res.Valid {
		return nil, errors.New("\"googleworkspace.connectedApp\" failed: no value provided for static field \"users\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"googleworkspace.connectedApp\" failed to cast field \"users\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Tokens accessor autogenerated
func (s *mqlGoogleworkspaceConnectedApp) Tokens() ([]interface{}, error) {
	res, ok := s.Cache.Load("tokens")
	if !ok || !res.Valid {
		return nil, errors.New("\"googleworkspace.connectedApp\" failed: no value provided for static field \"tokens\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"googleworkspace.connectedApp\" failed to cast field \"tokens\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGoogleworkspaceConnectedApp) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[googleworkspace.connectedApp].MqlCompute")
	switch name {
	case "clientId":
		return nil
	case "name":
