...
func (s *mqlVcd) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[vcd].MqlCompute")
	switch name {
	case "organizations":
...
// Compute accessor autogenerated
func (s *mqlVcdOrganization) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[vcd.organization].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlVcdOrganizationLdapSettings) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[vcd.organization.ldapSettings].MqlCompute")
	switch name {
	case "id":
		return nil
	case "customUsersOu":
...
// Compute accessor autogenerated
func (s *mqlVcdVdcProvider) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[vcd.vdcProvider].MqlCompute")
	switch name {
	case "name":
		return nil
	case "status":
...
// Compute accessor autogenerated
func (s *mqlVcdNetworkPool) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[vcd.networkPool].MqlCompute")
	switch name {
	case "name":
		return nil
	case "isBusy":
...
// Compute accessor autogenerated
func (s *mqlVcdExternalNetwork) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[vcd.externalNetwork].MqlCompute")
	switch name {
	case "id":
		return s.ComputeId()
	case "name":
...
// Compute accessor autogenerated
func (s *mqlVcdVm) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[vcd.vm].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlVcdServerInstance) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[vcd.serverInstance].MqlCompute")
	switch name {
	case "name":
		return nil
	case "isBusy":
...
// Compute accessor autogenerated
func (s *mqlVcdRight) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[vcd.right].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlVcdRole) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[vcd.role].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlVcdVdc) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[vcd.vdc].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlVcdVdcGroup) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[vcd.vdcGroup].MqlCompute")
	switch name {
	case "name":
		return nil
	case "description":
