...
func (s *mqlSlack) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[slack].MqlCompute")
	switch name {
	case "accessLogs":
...
// Compute accessor autogenerated
func (s *mqlSlackTeam) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[slack.team].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlSlackUsers) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[slack.users].MqlCompute")
	switch name {
	case "bots":
...
func newSlackUser(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "twoFactorType":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"slack.user\", its \"twoFactorType\" argument has the wrong type (expected type \"string\")")
			}
		case "hasFiles":
			if _, ok := val.(bool); !ok {
...
func (s *mqlSlackUser) Validate() error {
	...
	if _, ok := s.Cache.Load("twoFactorType"); !ok {
		return errors.New("Initialized \"slack.user\" resource without a \"twoFactorType\". This field is required.")
	}
...
// TwoFactorType accessor autogenerated
func (s *mqlSlackUser) TwoFactorType() (string, error) {
	res, ok := s.Cache.Load("twoFactorType")
	if !ok || !res.Valid {
		return "", errors.New("\"slack.user\" failed: no value provided for static field \"twoFactorType\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"slack.user\" failed to cast field \"twoFactorType\" to the right type (string): %#v", res)
	}
	return tres, nil
}
...
// Compute accessor autogenerated
func (s *mqlSlackUser) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[slack.user].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
...
// Compute accessor autogenerated
func (s *mqlSlackEnterpriseUser) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[slack.enterpriseUser].MqlCompute")
	switch name {
	case "id":
		return nil
	case "enterpriseId":
...
// Compute accessor autogenerated
func (s *mqlSlackUserGroup) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[slack.userGroup].MqlCompute")
	switch name {
	case "id":
		return nil
	case "teamId":
...
// Compute accessor autogenerated
func (s *mqlSlackLogin) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[slack.login].MqlCompute")
	switch name {
	case "userID":
		return nil
	case "username":
...
// Compute accessor autogenerated
func (s *mqlSlackConversation) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[slack.conversation].MqlCompute")
	switch name {
	case "id":
		return nil
	case "name":
