...
func Init(registry *resources.Registry) {
	...
	registry.AddFactory("github.gist", newGithubGist)
	registry.AddFactory("github.gistfile", newGithubGistfile)
	registry.AddFactory("github.issue", newGithubIssue)
}
...
type GithubOrganization interface {
	...
	Followers() (int64, error)
	Following() (int64, error)
...
func newGithubOrganization(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "avatarUrl":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.organization\", its \"avatarUrl\" argument has the wrong type (expected type \"string\")")
			}
		case "followers":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"github.organization\", its \"followers\" argument has the wrong type (expected type \"int64\")")
			}
		case "following":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"github.organization\", its \"following\" argument has the wrong type (expected type \"int64\")")
			}
		case "description":
			if _, ok := val.(string); !ok {
...
func (s *mqlGithubOrganization) Validate() error {
	...
	if _, ok := s.Cache.Load("avatarUrl"); !ok {
		return errors.New("Initialized \"github.organization\" resource without a \"avatarUrl\". This field is required.")
	}
	if _, ok := s.Cache.Load("followers"); !ok {
		return errors.New("Initialized \"github.organization\" resource without a \"followers\". This field is required.")
	}
	if _, ok := s.Cache.Load("following"); !ok {
		return errors.New("Initialized \"github.organization\" resource without a \"following\". This field is required.")
	}
...
func (s *mqlGithubOrganization) AvatarUrl() (string, error) {
	res, ok := s.Cache.Load("avatarUrl")
	if !ok || !res.Valid {
		return "", errors.New("\"github.organization\" failed: no value provided for static field \"avatarUrl\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.organization\" failed to cast field \"avatarUrl\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Followers accessor autogenerated
func (s *mqlGithubOrganization) Followers() (int64, error) {
	res, ok := s.Cache.Load("followers")
	if !ok || !res.Valid {
		return 0, errors.New("\"github.organization\" failed: no value provided for static field \"followers\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"github.organization\" failed to cast field \"followers\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// Following accessor autogenerated
func (s *mqlGithubOrganization) Following() (int64, error) {
	res, ok := s.Cache.Load("following")
	if !ok || !res.Valid {
		return 0, errors.New("\"github.organization\" failed: no value provided for static field \"following\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"github.organization\" failed to cast field \"following\" to the right type (int64): %#v", res)
	}
	return tres, nil
}
...
func newGithubUser(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "blog":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.user\", its \"blog\" argument has the wrong type (expected type \"string\")")
			}
		case "location":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.user\", its \"location\" argument has the wrong type (expected type \"string\")")
			}
		case "avatarUrl":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.user\", its \"avatarUrl\" argument has the wrong type (expected type \"string\")")
			}
		case "followers":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"github.user\", its \"followers\" argument has the wrong type (expected type \"int64\")")
			}
		case "following":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"github.user\", its \"following\" argument has the wrong type (expected type \"int64\")")
			}
		case "twitterUsername":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.user\", its \"twitterUsername\" argument has the wrong type (expected type \"string\")")
			}
		case "createdAt":
			if _, ok := val.(*time.Time); !ok {
		...
		case "gists":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"github.user\", its \"gists\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
...
func (s *mqlGithubUser) Validate() error {
	...
	if _, ok := s.Cache.Load("blog"); !ok {
		return errors.New("Initialized \"github.user\" resource without a \"blog\". This field is required.")
	}
	if _, ok := s.Cache.Load("location"); !ok {
		return errors.New("Initialized \"github.user\" resource without a \"location\". This field is required.")
	}
	if _, ok := s.Cache.Load("avatarUrl"); !ok {
		return errors.New("Initialized \"github.user\" resource without a \"avatarUrl\". This field is required.")
	}
	if _, ok := s.Cache.Load("followers"); !ok {
		return errors.New("Initialized \"github.user\" resource without a \"followers\". This field is required.")
	}
	if _, ok := s.Cache.Load("following"); !ok {
		return errors.New("Initialized \"github.user\" resource without a \"following\". This field is required.")
	}
	if _, ok := s.Cache.Load("twitterUsername"); !ok {
		return errors.New("Initialized \"github.user\" resource without a \"twitterUsername\". This field is required.")
	}
	if _, ok := s.Cache.Load("createdAt"); !ok {
...
// Blog accessor autogenerated
func (s *mqlGithubUser) Blog() (string, error) {
	res, ok := s.Cache.Load("blog")
	if !ok || !res.Valid {
		return "", errors.New("\"github.user\" failed: no value provided for static field \"blog\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.user\" failed to cast field \"blog\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Location accessor autogenerated
func (s *mqlGithubUser) Location() (string, error) {
	res, ok := s.Cache.Load("location")
	if !ok || !res.Valid {
		return "", errors.New("\"github.user\" failed: no value provided for static field \"location\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.user\" failed to cast field \"location\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// AvatarUrl accessor autogenerated
func (s *mqlGithubUser) AvatarUrl() (string, error) {
	res, ok := s.Cache.Load("avatarUrl")
	if !ok || !res.Valid {
		return "", errors.New("\"github.user\" failed: no value provided for static field \"avatarUrl\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.user\" failed to cast field \"avatarUrl\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Followers accessor autogenerated
func (s *mqlGithubUser) Followers() (int64, error) {
	res, ok := s.Cache.Load("followers")
	if !ok || !res.Valid {
		return 0, errors.New("\"github.user\" failed: no value provided for static field \"followers\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"github.user\" failed to cast field \"followers\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// Following accessor autogenerated
func (s *mqlGithubUser) Following() (int64, error) {
	res, ok := s.Cache.Load("following")
	if !ok || !res.Valid {
		return 0, errors.New("\"github.user\" failed: no value provided for static field \"following\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"github.user\" failed to cast field \"following\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// TwitterUsername accessor autogenerated
func (s *mqlGithubUser) TwitterUsername() (string, error) {
	res, ok := s.Cache.Load("twitterUsername")
	if !ok || !res.Valid {
		return "", errors.New("\"github.user\" failed: no value provided for static field \"twitterUsername\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.user\" failed to cast field \"twitterUsername\" to the right type (string): %#v", res)
	}
	return tres, nil
}
...
// Gists accessor autogenerated
func (s *mqlGithubUser) Gists() ([]interface{}, error) {
	res, ok := s.Cache.Load("gists")
	if !ok || !res.Valid {
		if err := s.ComputeGists(); err != nil {
			return nil, err
		}
		res, ok = s.Cache.Load("gists")
		if !ok {
			return nil, errors.New("\"github.user\" calculated \"gists\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "gists")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"github.user\" failed to cast field \"gists\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}
...
// ComputeGists computer autogenerated
func (s *mqlGithubUser) ComputeGists() error {
	var err error
	if _, ok := s.Cache.Load("gists"); ok {
		return nil
	}
	vres, err := s.GetGists()
	if _, ok := err.(resources.NotReadyError); ok {
	...
	s.Cache.Store("gists", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
	return nil
}
...
func newGithubRepository(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "stargazersCount":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"github.repository\", its \"stargazersCount\" argument has the wrong type (expected type \"int64\")")
			}
		case "openIssuesCount":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"github.repository\", its \"openIssuesCount\" argument has the wrong type (expected type \"int64\")")
			}
		case "createdAt":
			if _, ok := val.(*time.Time); !ok {
		...
		case "forks":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"github.repository\", its \"forks\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "stargazers":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"github.repository\", its \"stargazers\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "openIssues":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"github.repository\", its \"openIssues\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "closedIssues":
			if _, ok := val.([]interface{}); !ok {
...
func (s *mqlGithubRepository) Validate() error {
	...
	if _, ok := s.Cache.Load("openIssuesCount"); !ok {
		return errors.New("Initialized \"github.repository\" resource without a \"openIssuesCount\". This field is required.")
	}
	if _, ok := s.Cache.Load("createdAt"); !ok {
...
// StargazersCount accessor autogenerated
func (s *mqlGithubRepository) StargazersCount() (int64, error) {
	res, ok := s.Cache.Load("stargazersCount")
	if !ok || !res.Valid {
		return 0, errors.New("\"github.repository\" failed: no value provided for static field \"stargazersCount\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"github.repository\" failed to cast field \"stargazersCount\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// OpenIssuesCount accessor autogenerated
func (s *mqlGithubRepository) OpenIssuesCount() (int64, error) {
	res, ok := s.Cache.Load("openIssuesCount")
	if !ok || !res.Valid {
		return 0, errors.New("\"github.repository\" failed: no value provided for static field \"openIssuesCount\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"github.repository\" failed to cast field \"openIssuesCount\" to the right type (int64): %#v", res)
	}
	return tres, nil
}
...
// Forks accessor autogenerated
func (s *mqlGithubRepository) Forks() ([]interface{}, error) {
	res, ok := s.Cache.Load("forks")
	if !ok || !res.Valid {
		if err := s.ComputeForks(); err != nil {
			return nil, err
		}
		res, ok = s.Cache.Load("forks")
		if !ok {
			return nil, errors.New("\"github.repository\" calculated \"forks\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "forks")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"github.repository\" failed to cast field \"forks\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Stargazers accessor autogenerated
func (s *mqlGithubRepository) Stargazers() ([]interface{}, error) {
	res, ok := s.Cache.Load("stargazers")
	if !ok || !res.Valid {
		if err := s.ComputeStargazers(); err != nil {
			return nil, err
		}
		res, ok = s.Cache.Load("stargazers")
		if !ok {
			return nil, errors.New("\"github.repository\" calculated \"stargazers\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "stargazers")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"github.repository\" failed to cast field \"stargazers\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// OpenIssues accessor autogenerated
func (s *mqlGithubRepository) OpenIssues() ([]interface{}, error) {
	res, ok := s.Cache.Load("openIssues")
	if !ok || !res.Valid {
		if err := s.ComputeOpenIssues(); err != nil {
			return nil, err
		}
		res, ok = s.Cache.Load("openIssues")
		if !ok {
			return nil, errors.New("\"github.repository\" calculated \"openIssues\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "openIssues")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"github.repository\" failed to cast field \"openIssues\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// ClosedIssues accessor autogenerated
func (s *mqlGithubRepository) ClosedIssues() ([]interface{}, error) {
	res, ok := s.Cache.Load("closedIssues")
	if !ok || !res.Valid {
		if err := s.ComputeClosedIssues(); err != nil {
			return nil, err
		}
		res, ok = s.Cache.Load("closedIssues")
		if !ok {
			return nil, errors.New("\"github.repository\" calculated \"closedIssues\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "closedIssues")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"github.repository\" failed to cast field \"closedIssues\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}
...
func (s *mqlGithubRepository) MqlCompute(name string) error {
	...
	case "forks":
		return s.ComputeForks()
	case "stargazers":
		return s.ComputeStargazers()
	case "openIssues":
...
// ComputeForks computer autogenerated
func (s *mqlGithubRepository) ComputeForks() error {
	var err error
	if _, ok := s.Cache.Load("forks"); ok {
		return nil
	}
	vres, err := s.GetForks()
	if _, ok := err.(resources.NotReadyError); ok {
	...
	s.Cache.Store("forks", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
	return nil
}

// ComputeStargazers computer autogenerated
func (s *mqlGithubRepository) ComputeStargazers() error {
	var err error
	if _, ok := s.Cache.Load("stargazers"); ok {
		return nil
	}
	vres, err := s.GetStargazers()
	if _, ok := err.(resources.NotReadyError); ok {
		return err
	}
	s.Cache.Store("stargazers", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
	return nil
}

// ComputeOpenIssues computer autogenerated
func (s *mqlGithubRepository) ComputeOpenIssues() error {
	var err error
	if _, ok := s.Cache.Load("openIssues"); ok {
		return nil
	}
	vres, err := s.GetOpenIssues()
	if _, ok := err.(resources.NotReadyError); ok {
		return err
	}
	s.Cache.Store("openIssues", &resources.CacheEntry{Data: vres, Valid: true, Error: err, Timestamp: time.Now().Unix()})
	return nil
}

// ComputeClosedIssues computer autogenerated
func (s *mqlGithubRepository) ComputeClosedIssues() error {
	var err error
	if _, ok := s.Cache.Load("closedIssues"); ok {
		return nil
	}
	vres, err := s.GetClosedIssues()
	if _, ok := err.(resources.NotReadyError); ok {
		return err
	}
...
func newGithubBranch(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	...
	for name, val := range *args {
		...
		case "isProtected":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"github.branch\", its \"isProtected\" argument has the wrong type (expected type \"bool\")")
			}
		case "headCommit":
...
func (s *mqlGithubBranch) Validate() error {
	...
	if _, ok := s.Cache.Load("isProtected"); !ok {
		return errors.New("Initialized \"github.branch\" resource without a \"isProtected\". This field is required.")
	}
...
// IsProtected accessor autogenerated
func (s *mqlGithubBranch) IsProtected() (bool, error) {
	res, ok := s.Cache.Load("isProtected")
	if !ok || !res.Valid {
		return false, errors.New("\"github.branch\" failed: no value provided for static field \"isProtected\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"github.branch\" failed to cast field \"isProtected\" to the right type (bool): %#v", res)
	}
	return tres, nil
}
...
// MqlResource to retrieve the underlying resource info
func (s *mqlGithubGist) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the github.gist resource
func newGithubGist(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGithubGist{runtime.NewResource("github.gist")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.gist\", its \"id\" argument has the wrong type (expected type \"string\")")
			}
		case "description":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.gist\", its \"description\" argument has the wrong type (expected type \"string\")")
			}
		case "createdAt":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"github.gist\", its \"createdAt\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "updatedAt":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"github.gist\", its \"updatedAt\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "owner":
			if _, ok := val.(GithubUser); !ok {
				return nil, errors.New("Failed to initialize \"github.gist\", its \"owner\" argument has the wrong type (expected type \"GithubUser\")")
			}
		case "public":
			if _, ok := val.(bool); !ok {
				return nil, errors.New("Failed to initialize \"github.gist\", its \"public\" argument has the wrong type (expected type \"bool\")")
			}
		case "files":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"github.gist\", its \"files\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"github.gist\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized github.gist with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGithubGist) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"github.gist\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("description"); !ok {
		return errors.New("Initialized \"github.gist\" resource without a \"description\". This field is required.")
	}
	if _, ok := s.Cache.Load("createdAt"); !ok {
		return errors.New("Initialized \"github.gist\" resource without a \"createdAt\". This field is required.")
	}
	if _, ok := s.Cache.Load("updatedAt"); !ok {
		return errors.New("Initialized \"github.gist\" resource without a \"updatedAt\". This field is required.")
	}
	if _, ok := s.Cache.Load("owner"); !ok {
		return errors.New("Initialized \"github.gist\" resource without a \"owner\". This field is required.")
	}
	if _, ok := s.Cache.Load("public"); !ok {
		return errors.New("Initialized \"github.gist\" resource without a \"public\". This field is required.")
	}
	if _, ok := s.Cache.Load("files"); !ok {
		return errors.New("Initialized \"github.gist\" resource without a \"files\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGithubGist) Register(name string) error {
	log.Trace().Str("field", name).Msg("[github.gist].Register")
	switch name {
	case "id":
		return nil
	case "description":
	...
	case "files":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"github.gist\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGithubGist) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[github.gist].Field")
	switch name {
	case "id":
		return s.Id()
	case "description":
	...
	case "files":
		return s.Files()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"github.gist\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGithubGist) Id() (string, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return "", errors.New("\"github.gist\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.gist\" failed to cast field \"id\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Description accessor autogenerated
func (s *mqlGithubGist) Description() (string, error) {
	res, ok := s.Cache.Load("description")
	if !ok || !res.Valid {
		return "", errors.New("\"github.gist\" failed: no value provided for static field \"description\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.gist\" failed to cast field \"description\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// CreatedAt accessor autogenerated
func (s *mqlGithubGist) CreatedAt() (*time.Time, error) {
	res, ok := s.Cache.Load("createdAt")
	if !ok || !res.Valid {
		return nil, errors.New("\"github.gist\" failed: no value provided for static field \"createdAt\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"github.gist\" failed to cast field \"createdAt\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// UpdatedAt accessor autogenerated
func (s *mqlGithubGist) UpdatedAt() (*time.Time, error) {
	res, ok := s.Cache.Load("updatedAt")
	if !ok || !res.Valid {
		return nil, errors.New("\"github.gist\" failed: no value provided for static field \"updatedAt\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"github.gist\" failed to cast field \"updatedAt\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Owner accessor autogenerated
func (s *mqlGithubGist) Owner() (GithubUser, error) {
	res, ok := s.Cache.Load("owner")
	if !ok || !res.Valid {
		return nil, errors.New("\"github.gist\" failed: no value provided for static field \"owner\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(GithubUser)
	if !ok {
		return nil, fmt.Errorf("\"github.gist\" failed to cast field \"owner\" to the right type (GithubUser): %#v", res)
	}
	return tres, nil
}

// Public accessor autogenerated
func (s *mqlGithubGist) Public() (bool, error) {
	res, ok := s.Cache.Load("public")
	if !ok || !res.Valid {
		return false, errors.New("\"github.gist\" failed: no value provided for static field \"public\"")
	}
	if res.Error != nil {
		return false, res.Error
	}
	tres, ok := res.Data.(bool)
	if !ok {
		return false, fmt.Errorf("\"github.gist\" failed to cast field \"public\" to the right type (bool): %#v", res)
	}
	return tres, nil
}

// Files accessor autogenerated
func (s *mqlGithubGist) Files() ([]interface{}, error) {
	res, ok := s.Cache.Load("files")
	if !ok || !res.Valid {
		return nil, errors.New("\"github.gist\" failed: no value provided for static field \"files\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"github.gist\" failed to cast field \"files\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGithubGist) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[github.gist].MqlCompute")
	switch name {
	case "id":
		return nil
	case "description":
...
// MqlResource to retrieve the underlying resource info
func (s *mqlGithubGistfile) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the github.gistfile resource
func newGithubGistfile(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGithubGistfile{runtime.NewResource("github.gistfile")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "gistId":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.gistfile\", its \"gistId\" argument has the wrong type (expected type \"string\")")
			}
		case "filename":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.gistfile\", its \"filename\" argument has the wrong type (expected type \"string\")")
			}
		case "type":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.gistfile\", its \"type\" argument has the wrong type (expected type \"string\")")
			}
		case "language":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.gistfile\", its \"language\" argument has the wrong type (expected type \"string\")")
			}
		case "rawUrl":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.gistfile\", its \"rawUrl\" argument has the wrong type (expected type \"string\")")
			}
		case "size":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"github.gistfile\", its \"size\" argument has the wrong type (expected type \"int64\")")
			}
		case "content":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.gistfile\", its \"content\" argument has the wrong type (expected type \"string\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"github.gistfile\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized github.gistfile with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGithubGistfile) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("gistId"); !ok {
		return errors.New("Initialized \"github.gistfile\" resource without a \"gistId\". This field is required.")
	}
	if _, ok := s.Cache.Load("filename"); !ok {
		return errors.New("Initialized \"github.gistfile\" resource without a \"filename\". This field is required.")
	}
	if _, ok := s.Cache.Load("type"); !ok {
		return errors.New("Initialized \"github.gistfile\" resource without a \"type\". This field is required.")
	}
	if _, ok := s.Cache.Load("language"); !ok {
		return errors.New("Initialized \"github.gistfile\" resource without a \"language\". This field is required.")
	}
	if _, ok := s.Cache.Load("rawUrl"); !ok {
		return errors.New("Initialized \"github.gistfile\" resource without a \"rawUrl\". This field is required.")
	}
	if _, ok := s.Cache.Load("size"); !ok {
		return errors.New("Initialized \"github.gistfile\" resource without a \"size\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGithubGistfile) Register(name string) error {
	log.Trace().Str("field", name).Msg("[github.gistfile].Register")
	switch name {
	case "gistId":
		return nil
	case "filename":
	...
	case "content":
		return nil
	default:
		return errors.New("Cannot find field '" + name + "' in \"github.gistfile\" resource")
	}
}

// Field accessor autogenerated
func (s *mqlGithubGistfile) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[github.gistfile].Field")
	switch name {
	case "gistId":
		return s.GistId()
	case "filename":
	...
	case "content":
		return s.Content()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"github.gistfile\" resource")
	}
}

// GistId accessor autogenerated
func (s *mqlGithubGistfile) GistId() (string, error) {
	res, ok := s.Cache.Load("gistId")
	if !ok || !res.Valid {
		return "", errors.New("\"github.gistfile\" failed: no value provided for static field \"gistId\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.gistfile\" failed to cast field \"gistId\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Filename accessor autogenerated
func (s *mqlGithubGistfile) Filename() (string, error) {
	res, ok := s.Cache.Load("filename")
	if !ok || !res.Valid {
		return "", errors.New("\"github.gistfile\" failed: no value provided for static field \"filename\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.gistfile\" failed to cast field \"filename\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Type accessor autogenerated
func (s *mqlGithubGistfile) Type() (string, error) {
	res, ok := s.Cache.Load("type")
	if !ok || !res.Valid {
		return "", errors.New("\"github.gistfile\" failed: no value provided for static field \"type\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.gistfile\" failed to cast field \"type\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Language accessor autogenerated
func (s *mqlGithubGistfile) Language() (string, error) {
	res, ok := s.Cache.Load("language")
	if !ok || !res.Valid {
		return "", errors.New("\"github.gistfile\" failed: no value provided for static field \"language\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.gistfile\" failed to cast field \"language\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// RawUrl accessor autogenerated
func (s *mqlGithubGistfile) RawUrl() (string, error) {
	res, ok := s.Cache.Load("rawUrl")
	if !ok || !res.Valid {
		return "", errors.New("\"github.gistfile\" failed: no value provided for static field \"rawUrl\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.gistfile\" failed to cast field \"rawUrl\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Size accessor autogenerated
func (s *mqlGithubGistfile) Size() (int64, error) {
	res, ok := s.Cache.Load("size")
	if !ok || !res.Valid {
		return 0, errors.New("\"github.gistfile\" failed: no value provided for static field \"size\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"github.gistfile\" failed to cast field \"size\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// Content accessor autogenerated
func (s *mqlGithubGistfile) Content() (string, error) {
	res, ok := s.Cache.Load("content")
	if !ok || !res.Valid {
		if err := s.ComputeContent(); err != nil {
			return "", err
		...
		res, ok = s.Cache.Load("content")
		if !ok {
			return "", errors.New("\"github.gistfile\" calculated \"content\" but didn't find its value in cache.")
		}
		s.MotorRuntime.Trigger(s, "content")
	}
	if res.Error != nil {
	...
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.gistfile\" failed to cast field \"content\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGithubGistfile) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[github.gistfile].MqlCompute")
	switch name {
	case "gistId":
		return nil
	case "filename":
...
// ComputeContent computer autogenerated
func (s *mqlGithubGistfile) ComputeContent() error {
	var err error
	if _, ok := s.Cache.Load("content"); ok {
		return nil
	}
...
type GithubIssue interface {
	...
	CreatedAt() (*time.Time, error)
	UpdatedAt() (*time.Time, error)
	ClosedAt() (*time.Time, error)
	Assignees() ([]interface{}, error)
	ClosedBy() (GithubUser, error)
}
...
// MqlResource to retrieve the underlying resource info
func (s *mqlGithubIssue) MqlResource() *resources.Resource {
	return s.Resource
}

// create a new instance of the github.issue resource
func newGithubIssue(runtime *resources.Runtime, args *resources.Args) (interface{}, error) {
	// User hooks
	var err error
	res := mqlGithubIssue{runtime.NewResource("github.issue")}
	// assign all named fields
	var id string
	...
	for name, val := range *args {
		...
		case "id":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"github.issue\", its \"id\" argument has the wrong type (expected type \"int64\")")
			}
		case "number":
			if _, ok := val.(int64); !ok {
				return nil, errors.New("Failed to initialize \"github.issue\", its \"number\" argument has the wrong type (expected type \"int64\")")
			}
		case "title":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.issue\", its \"title\" argument has the wrong type (expected type \"string\")")
			}
		case "state":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.issue\", its \"state\" argument has the wrong type (expected type \"string\")")
			}
		case "body":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.issue\", its \"body\" argument has the wrong type (expected type \"string\")")
			}
		case "url":
			if _, ok := val.(string); !ok {
				return nil, errors.New("Failed to initialize \"github.issue\", its \"url\" argument has the wrong type (expected type \"string\")")
			}
		case "createdAt":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"github.issue\", its \"createdAt\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "updatedAt":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"github.issue\", its \"updatedAt\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "closedAt":
			if _, ok := val.(*time.Time); !ok {
				return nil, errors.New("Failed to initialize \"github.issue\", its \"closedAt\" argument has the wrong type (expected type \"*time.Time\")")
			}
		case "assignees":
			if _, ok := val.([]interface{}); !ok {
				return nil, errors.New("Failed to initialize \"github.issue\", its \"assignees\" argument has the wrong type (expected type \"[]interface{}\")")
			}
		case "closedBy":
			if _, ok := val.(GithubUser); !ok {
				return nil, errors.New("Failed to initialize \"github.issue\", its \"closedBy\" argument has the wrong type (expected type \"GithubUser\")")
			}
		case "__id":
			idVal, ok := val.(string)
			if !ok {
				return nil, errors.New("Failed to initialize \"github.issue\", its \"__id\" argument has the wrong type (expected type \"string\")")
			}
			id = idVal
		default:
			return nil, errors.New("Initialized github.issue with unknown argument " + name)
		}
		res.Cache.Store(name, &resources.CacheEntry{Data: val, Valid: true, Timestamp: now})
	}
...
func (s *mqlGithubIssue) Validate() error {
	// required arguments
	if _, ok := s.Cache.Load("id"); !ok {
		return errors.New("Initialized \"github.issue\" resource without a \"id\". This field is required.")
	}
	if _, ok := s.Cache.Load("number"); !ok {
		return errors.New("Initialized \"github.issue\" resource without a \"number\". This field is required.")
	}
	if _, ok := s.Cache.Load("title"); !ok {
		return errors.New("Initialized \"github.issue\" resource without a \"title\". This field is required.")
	}
	if _, ok := s.Cache.Load("state"); !ok {
		return errors.New("Initialized \"github.issue\" resource without a \"state\". This field is required.")
	}
	if _, ok := s.Cache.Load("body"); !ok {
		return errors.New("Initialized \"github.issue\" resource without a \"body\". This field is required.")
	}
	if _, ok := s.Cache.Load("url"); !ok {
		return errors.New("Initialized \"github.issue\" resource without a \"url\". This field is required.")
	}
	if _, ok := s.Cache.Load("createdAt"); !ok {
		return errors.New("Initialized \"github.issue\" resource without a \"createdAt\". This field is required.")
	}
	if _, ok := s.Cache.Load("updatedAt"); !ok {
		return errors.New("Initialized \"github.issue\" resource without a \"updatedAt\". This field is required.")
	}
	if _, ok := s.Cache.Load("closedAt"); !ok {
		return errors.New("Initialized \"github.issue\" resource without a \"closedAt\". This field is required.")
	}
	if _, ok := s.Cache.Load("assignees"); !ok {
		return errors.New("Initialized \"github.issue\" resource without a \"assignees\". This field is required.")
	}
	if _, ok := s.Cache.Load("closedBy"); !ok {
		return errors.New("Initialized \"github.issue\" resource without a \"closedBy\". This field is required.")
	}
...
// Register accessor autogenerated
func (s *mqlGithubIssue) Register(name string) error {
	log.Trace().Str("field", name).Msg("[github.issue].Register")
	switch name {
	case "id":
		return nil
	case "number":
...
// Field accessor autogenerated
func (s *mqlGithubIssue) Field(name string) (interface{}, error) {
	log.Trace().Str("field", name).Msg("[github.issue].Field")
	switch name {
	case "id":
		return s.Id()
	case "number":
	...
	case "closedBy":
		return s.ClosedBy()
	default:
		return nil, fmt.Errorf("Cannot find field '" + name + "' in \"github.issue\" resource")
	}
}

// Id accessor autogenerated
func (s *mqlGithubIssue) Id() (int64, error) {
	res, ok := s.Cache.Load("id")
	if !ok || !res.Valid {
		return 0, errors.New("\"github.issue\" failed: no value provided for static field \"id\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"github.issue\" failed to cast field \"id\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// Number accessor autogenerated
func (s *mqlGithubIssue) Number() (int64, error) {
	res, ok := s.Cache.Load("number")
	if !ok || !res.Valid {
		return 0, errors.New("\"github.issue\" failed: no value provided for static field \"number\"")
	}
	if res.Error != nil {
		return 0, res.Error
	}
	tres, ok := res.Data.(int64)
	if !ok {
		return 0, fmt.Errorf("\"github.issue\" failed to cast field \"number\" to the right type (int64): %#v", res)
	}
	return tres, nil
}

// Title accessor autogenerated
func (s *mqlGithubIssue) Title() (string, error) {
	res, ok := s.Cache.Load("title")
	if !ok || !res.Valid {
		return "", errors.New("\"github.issue\" failed: no value provided for static field \"title\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.issue\" failed to cast field \"title\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// State accessor autogenerated
func (s *mqlGithubIssue) State() (string, error) {
	res, ok := s.Cache.Load("state")
	if !ok || !res.Valid {
		return "", errors.New("\"github.issue\" failed: no value provided for static field \"state\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.issue\" failed to cast field \"state\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Body accessor autogenerated
func (s *mqlGithubIssue) Body() (string, error) {
	res, ok := s.Cache.Load("body")
	if !ok || !res.Valid {
		return "", errors.New("\"github.issue\" failed: no value provided for static field \"body\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.issue\" failed to cast field \"body\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// Url accessor autogenerated
func (s *mqlGithubIssue) Url() (string, error) {
	res, ok := s.Cache.Load("url")
	if !ok || !res.Valid {
		return "", errors.New("\"github.issue\" failed: no value provided for static field \"url\"")
	}
	if res.Error != nil {
		return "", res.Error
	}
	tres, ok := res.Data.(string)
	if !ok {
		return "", fmt.Errorf("\"github.issue\" failed to cast field \"url\" to the right type (string): %#v", res)
	}
	return tres, nil
}

// CreatedAt accessor autogenerated
func (s *mqlGithubIssue) CreatedAt() (*time.Time, error) {
	res, ok := s.Cache.Load("createdAt")
	if !ok || !res.Valid {
		return nil, errors.New("\"github.issue\" failed: no value provided for static field \"createdAt\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"github.issue\" failed to cast field \"createdAt\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// UpdatedAt accessor autogenerated
func (s *mqlGithubIssue) UpdatedAt() (*time.Time, error) {
	res, ok := s.Cache.Load("updatedAt")
	if !ok || !res.Valid {
		return nil, errors.New("\"github.issue\" failed: no value provided for static field \"updatedAt\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"github.issue\" failed to cast field \"updatedAt\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// ClosedAt accessor autogenerated
func (s *mqlGithubIssue) ClosedAt() (*time.Time, error) {
	res, ok := s.Cache.Load("closedAt")
	if !ok || !res.Valid {
		return nil, errors.New("\"github.issue\" failed: no value provided for static field \"closedAt\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(*time.Time)
	if !ok {
		return nil, fmt.Errorf("\"github.issue\" failed to cast field \"closedAt\" to the right type (*time.Time): %#v", res)
	}
	return tres, nil
}

// Assignees accessor autogenerated
func (s *mqlGithubIssue) Assignees() ([]interface{}, error) {
	res, ok := s.Cache.Load("assignees")
	if !ok || !res.Valid {
		return nil, errors.New("\"github.issue\" failed: no value provided for static field \"assignees\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.([]interface{})
	if !ok {
		return nil, fmt.Errorf("\"github.issue\" failed to cast field \"assignees\" to the right type ([]interface{}): %#v", res)
	}
	return tres, nil
}

// ClosedBy accessor autogenerated
func (s *mqlGithubIssue) ClosedBy() (GithubUser, error) {
	res, ok := s.Cache.Load("closedBy")
	if !ok || !res.Valid {
		return nil, errors.New("\"github.issue\" failed: no value provided for static field \"closedBy\"")
	}
	if res.Error != nil {
		return nil, res.Error
	}
	tres, ok := res.Data.(GithubUser)
	if !ok {
		return nil, fmt.Errorf("\"github.issue\" failed to cast field \"closedBy\" to the right type (GithubUser): %#v", res)
	}
	return tres, nil
}

// Compute accessor autogenerated
func (s *mqlGithubIssue) MqlCompute(name string) error {
	log.Trace().Str("field", name).Msg("[github.issue].MqlCompute")
	switch name {
	case "id":
		return nil
	case "number":
